...
import { ShowVehiculeComponent } from './pages/vehicules/show-vehicule/show-vehicule.component';  // Liste des véhicules
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: ':vehiculeId/view',
            component: ShowVehiculeComponent  // Affiche les détails d'un véhicule
          }
        ]
      },      
      {
