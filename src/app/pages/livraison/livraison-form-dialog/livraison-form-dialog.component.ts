...
// import { Component, OnInit, AfterViewInit, Inject, HostListener, ElementRef } from '@angular/core';
// import { FormBuilder, FormGroup, Validators, ReactiveFormsModule } from '@angular/forms';
// import { MatDialogRef, MAT_DIALOG_DATA, MatDialog } from '@angular/material/dialog';
// import { LivraisonService } from '../livraison.service';
// import { LivraisonDto } from '../../Model/livraison.dto';
...
//   colisDisponibles: any[] = [];
//   isEditMode = false;
//   private ignoreFirstClickOutside = true; // Ignore le premier clic pour éviter la fermeture immédiate
...
//     // Délai avant d'activer la fermeture par clic extérieur
//     setTimeout(() => {
//       this.ignoreFirstClickOutside = false;
//     }, 300); // 300 ms pour éviter la fermeture immédiate
//   }
